        ...
        <div class="relative z-50 mx-auto mt-36 w-3/6 p-10 bg-deepblue rounded-xl h-3/4" id="contentLogs">
            ...
            <form class="flex items-center my-5" onsubmit="return false">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="research-bar-logging" class="block w-full rounded-lg border border-white bg-deepblue p-2.5 pl-10 text-sm text-white focus:border-lightblue focus:ring-lightblue" placeholder="Rechercher un logs"/>
                </div>
